 ...
 * @author miyug
 */
public class MenuDeleteGUI extends javax.swing.JFrame {

    /**
     * Creates new form MenuDeleteGUI
     */
    public MenuDeleteGUI() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MenuDeleteGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new MenuDeleteGUI().setVisible(true);
            }
        });
    }

...
public class CustomerUpdateGUI extends javax.swing.JFrame {
    ...
    /**
     * Creates new form CustomerDeleteGUI
     */
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        controller.updateCustomer(cusId, fname, lname, email, telNo, username, password);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CustomerUpdateGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CustomerUpdateGUI().setVisible(true);
            }
        });
    }

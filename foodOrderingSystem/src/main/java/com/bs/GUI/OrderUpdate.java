...
public class OrderUpdate extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("ORDER UPDATE");

        jLabel2.setText("Order ID");

        jLabel3.setText("Customer ID");

        jLabel4.setText("Receiver's address");
...
OrderController controller=new OrderController();
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        int customerId=Integer.parseInt(jTextField2.getText());
        String recAddress=jTextField3.getText();
        String sendAddress=jTextField4.getText();
        double totalAmount=Double.parseDouble(jTextField5.getText());
        boolean orderStatus=Boolean.parseBoolean(jTextField6.getText());
        controller.updateOrder(orderId, customerId, recAddress, sendAddress, totalAmount, orderStatus);

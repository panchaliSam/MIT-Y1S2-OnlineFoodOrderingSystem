 ...
 */
public class DeliveryPersonSelectGUI extends javax.swing.JFrame {

    /**
     * Creates new form DeliveryPersonSelectGUI
     */
    public DeliveryPersonSelectGUI() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("DELIVEY PERSON SELECT");
...
>>>>>>> f69c1c8fbd62ccf5873e4f20967824565f7677ec
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DeliveryPersonSelectGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DeliveryPersonSelectGUI().setVisible(true);
            }
        });
    }

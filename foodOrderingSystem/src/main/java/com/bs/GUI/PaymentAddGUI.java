 ...
 * @author Asus
 */
public class PaymentAddGUI extends javax.swing.JFrame {

    /**
     * Creates new form PaymentAddGUI
     */
    public PaymentAddGUI() {
        initComponents();
    }
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        controller.addPayment(amount, paymentMethod, paymentStatus, customerId);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PaymentAddGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PaymentAddGUI().setVisible(true);
            }
        });
    }
